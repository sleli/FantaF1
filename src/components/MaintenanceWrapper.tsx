...
export default function MaintenanceWrapper({ children }: MaintenanceWrapperProps) {
  ...
  useEffect(() => {
    // Controlla la modalità manutenzione
    const checkMaintenanceMode = async () => {
      try {
        ...
        // In caso di errore, assumiamo che non sia in manutenzione
  ...
  // Se stiamo caricando, mostra un loading
  if (isLoading) {
    return (
  ...
  // Se siamo in modalità manutenzione e non sulla pagina di manutenzione
  ...
  // Se non siamo in modalità manutenzione, mostra il contenuto normale
  return <>{children}</>;
}
